...
$sqlImgs = "SELECT image_urd 
            FROM car_images 
            WHERE car_id = " . (int)$order['car_id'] . " 
            LIMIT 4";
...
<body>
    <div class="container">
        <main class="main-content">
            <h1 class="chapter">Chi tiết đơn hàng</h1>
                    ...
                    <div class="od-card">
                        ...
                        <div class="od-car-info">
                            ...
                            <div>
                                ...
                                <p>
                                    Trạng thái xe:
                                    <?php if ($order['car_status'] == 'available' && $order['stock_quantity'] > 0) { ?>
                                        <span style="color:green;font-weight:bold;">Còn hàng</span>
                                    <?php } else { ?>
                                        <span style="color:red;font-weight:bold;">Đã bán / hết hàng</span>
                                    <?php } ?>
                                </p>
                            </div>
                        </div>
